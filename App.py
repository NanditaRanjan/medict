...
def main():
    ...
    if show_about_me:
        st.markdown(
            "<h2>About Me</h2>"
            "<p>Hello! I am Nandita Ranjan, a passionate developer interested in machine learning and web development. "
    ...
    st.markdown('<div style="text-align: center; margin-top: 2rem;">'
                ...
                '© 2024 Nandita Ranjan. All rights reserved.</p></div>', unsafe_allow_html=True)
